...
<template>
    ...
    <div class="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div class="py-12 px-4">
            <h1 class="text-4xl font-bold text-center text-gray-800 mb-2">{{ categoryTitle ?? appName }}</h1>
            <p class="text-center text-gray-500 mb-10 text-lg">{{ t('gallery.subtitle') }}</p>

            <div class="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-2">
                <a
                ...
                >
                    <figure class="group overflow-hidden rounded-2xl shadow-md bg-white hover:shadow-xl transition-shadow duration-300 cursor-pointer">
                        ...
                        <figcaption class="px-4 py-3 flex items-center gap-2 text-sm">
                            ...
                            <span class="flex-1 text-gray-700 font-medium text-center truncate">{{ t(image.caption) }}</span>
                            <button
                                type="button"
            ...
            <!-- Pagination -->
            <div class="max-w-6xl mx-auto mt-10 flex items-center justify-center gap-1">
